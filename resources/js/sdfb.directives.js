angular.module('superDynamicFormBuilder').directive('jqdatepicker', function () {
    return {
        restrict: 'A',
        require: 'ngModel',
...
angular.module('superDynamicFormBuilder').directive("checkboxGroup", function () {
    return {
        restrict: "A",
        //scope : {
        //    model: "=",
...
angular.module('superDynamicFormBuilder').directive("copyValue", function () {
    return {
        restrict: "A",
...
angular.module('superDynamicFormBuilder').directive("fileUpload", function ($upload) {
    return {
        restrict: "A",
        link: function (scope, elem, attrs) {
...
angular.module('superDynamicFormBuilder').directive("radioChecked", function () {
    return {
        restrict: "A",
        link: function (scope, elem, attrs) {
...
angular.module('superDynamicFormBuilder').directive("addButton", function (formService) {
    return {
        restrict: 'AE',
        replace: true,
...
angular.module('superDynamicFormBuilder').directive("uploadAttachment", function (formService) {
    return {
        restrict: 'AE',
        //replace:true,
        ...
        templateUrl: 'SiteAsset/JavaScript/templates/fileUpload.html',
        controller: function ($scope) {
            ...
            function uploadoneFile(file, files, i) {
                ...
                promise.then(function (fileLink) {
                    var filelinkHtml = getfileLink(fileLink.link, fileLink.fileName);
...
angular.module('superDynamicFormBuilder').directive('dynamic', function ($compile) {
    return {
        restrict: 'A',
        replace: true,
...
angular.module('superDynamicFormBuilder').directive('kcdRecompile', function ($compile, $parse) {
    'use strict';
    return {
...
angular.module('superDynamicFormBuilder').directive('clickAndDisable', function () {
    return {
        link: function (scope, iElement, iAttrs) {
...
angular.module('superDynamicFormBuilder').directive('manualInstruction', function () {
    return {
        link: function (scope, iElement, iAttrs) {
